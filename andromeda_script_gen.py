...
Sources = ['J0740+3756','J0744+1825','J0912+5650', 'J0945+1726,','J1007+5802', 'J1010+1851', 'J1049+6406', 'J1207+1127','J1214+1631','J1238+5249','J1246+2245','J1344+2852','J1350+1740','J1416+6205','J1512+1456','J1548+1935','J1553+1401','J1553+1401','J1612+2029','J1635+2547','J1642+1848','J1643+1235']
for source in Sources:
    ...
    shutil.copyfile('/data/astrolab/Carlson/Astro/VLASS_Data/Large_VLASS_Automation/SEIP_parameter.list','working/SEIP_parameter.list')
    shutil.copyfile('/data/astrolab/Carlson/Astro/VLASS_Data/Large_VLASS_Automation/run_SE.sh','working/run_SE.sh')



    with open('working/SEIP_parameter.list', 'r') as file :
        filedata = file.read()

    filedata = filedata.replace('00:00:00.0 +00.00.00.0',sig_source_df['Coords'].to_string())
    filedata = filedata.replace('J0000+0000',J_Name_of_Source)

    with open('working/SEIP_parameter.list', 'w') as file :
        file.write(filedata)
